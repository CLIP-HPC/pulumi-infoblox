...
import (
	...
	"github.com/CLIP-HPC/pulumi-infoblox/provider/pkg/version"
...
func Provider() tfbridge.ProviderInfo {
	...
	p := shimv1.NewProvider(infoblox.Provider().(*schema.Provider))
	...
	prov := tfbridge.ProviderInfo{
		...
		Repository:  "https://github.com/CLIP-HPC/pulumi-infoblox",
